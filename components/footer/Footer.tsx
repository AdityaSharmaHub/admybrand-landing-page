    ...
    <footer className="py-16 border-t border-white/10">
        <div className="container mx-auto px-6 md:px-20">
          <div className="grid md:grid-cols-5 gap-10 mb-12">
            <div className="space-y-4 col-span-2 md:pr-40">
              <div className="flex items-center space-x-3">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="text-sm font-medium text-gray-300 leading-tight">AI Suite</span>
                </div>
              </div>
              <p className="text-gray-400">Transform your marketing with the power of artificial intelligence.</p>
            </div>
          ...
          <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 mb-6 md:mb-0 text-sm">© 2025 ADmyBRAND</p>
            <p className="text-gray-400 mb-8 md:mb-0 text-sm">
              <span>Build with ❤️ by </span> 
              <Link href="https://adityacodes.com" target="_blank" className='underline underline-offset-4 hover:text-white'>Aditya Sharma</Link>
            </p>
